...
def AT_lambda_landau_from_energy_loss_multi ( n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um, lambda_landau):
	'''
	...
	c_output = c_function( c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_lambda_landau)
	return c_output,  c_lambda_landau._obj
...
def AT_energy_loss_from_lambda_landau_multi ( n, lambda_landau, E_MeV_u, particle_no, material_no, slab_thickness_um, energy_loss_keV):
	'''
	...
	c_output = c_function( c_n, c_lambda_landau, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_energy_loss_keV)
...
def AT_lambda_vavilov_from_energy_loss_multi ( n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um, lambda_vavilov):
	'''
	 * Computes the lambda parameter for the
	...
	c_output = c_function( c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_lambda_vavilov)
	return c_output,  c_lambda_vavilov._obj
...
def AT_energy_loss_from_lambda_vavilov_multi ( n, lambda_vavilov, E_MeV_u, particle_no, material_no, slab_thickness_um, energy_loss_keV):
	'''
	...
	c_output = c_function( c_n, c_lambda_vavilov, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_energy_loss_keV)
	return c_output,  c_energy_loss_keV._obj
...
def AT_energy_loss_from_lambda_gauss_multi ( n, lambda_gauss, E_MeV_u, particle_no, material_no, slab_thickness_um, energy_loss_keV):
	'''
	 * Computes the energy loss from the lambda parameter of the
	...
	c_output = c_function( c_n, c_lambda_gauss, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_energy_loss_keV)
	return c_output,  c_energy_loss_keV._obj
...
def AT_gamma_response ( number_of_doses, d_Gy, gamma_model, gamma_parameter, lethal_event_mode, response):
	'''
	...
	tmp_array = (*number_of_doses)()
	c_response= ctypes.byref(tmp_array)

	c_lethal_event_mode = ctypes.c_bool(lethal_event_mode)
	c_function =  libamtrack.AT_gamma_response
	c_output = c_function( c_number_of_doses, c_d_Gy, c_gamma_model, c_gamma_parameter, c_lethal_event_mode, c_response)
	return c_output,  c_response._obj
...
def AT_KatzModel_inactivation_cross_section_approximation_m2 ( E_MeV_u, particle_no, material_no, rdd_model, er_model, m_number_of_targets, sigma0_m2, kappa):
	'''
	 * TODO
	 * @param[in] E_MeV_u                   TODO
	 * @param[in] particle_no               TODO
	...
	c_function.restype = ctypes.c_double
	c_output = c_function( c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_er_model, c_m_number_of_targets, c_sigma0_m2, c_kappa)
	return c_output
...
def AT_Mass_Stopping_Power ( stopping_power_source, n, E_MeV_u, particle_no, material_no, stopping_power_MeV_cm2_g):
	...
	c_function.restype = ctypes.c_int
	c_output = c_function( c_stopping_power_source, c_n, c_E_MeV_u, c_particle_no, c_material_no, c_stopping_power_MeV_cm2_g)
...
def AT_Mass_Stopping_Power_with_no ( stopping_power_source_no, n, E_MeV_u, particle_no, material_no, stopping_power_MeV_cm2_g):
	'''
	 * Retrieves the electronic mass stopping power in MeV*cm2/g
	 * for the requested energies and particles for a specified
	 * material and data source. The data source is thereby
	...
	c_function.restype = ctypes.c_int
	c_output = c_function( c_stopping_power_source_no, c_n, c_E_MeV_u, c_particle_no, c_material_no, c_stopping_power_MeV_cm2_g)
	return c_output,  c_stopping_power_MeV_cm2_g._obj
...
def AT_Stopping_Power_with_no ( stopping_power_source_no, n, E_MeV_u, particle_no, material_no, stopping_power_keV_um):
	...
	c_function.restype = ctypes.c_int
	c_output = c_function( c_stopping_power_source_no, c_n, c_E_MeV_u, c_particle_no, c_material_no, c_stopping_power_keV_um)
	return c_output,  c_stopping_power_keV_um._obj
...
def AT_Bethe_energy_loss_MeV_cm2_g ( n, E_MeV_u, particle_no, material_no, E_restricted_keV, Mass_Stopping_Power_MeV_cm2_g):
	'''
	...
	c_n = ctypes.c_long(n)
	c_function =  libamtrack.AT_Bethe_energy_loss_MeV_cm2_g
...
def AT_translate_dose_into_DSB_distribution ( n_bins_f, f_d_Gy, f_dd_Gy, f, enhancement_factor, DSB_per_Gy_per_domain, domains_per_nucleus, write_output, total_pDSBs, total_nDSBs, number_of_iDSBs, number_of_cDSBs, avg_number_of_DSBs_in_cDSBs):
	'''
	...
	c_output = c_function( c_n_bins_f, c_f_d_Gy, c_f_dd_Gy, c_f, c_enhancement_factor, c_DSB_per_Gy_per_domain, c_domains_per_nucleus, c_write_output, c_total_pDSBs, c_total_nDSBs, c_number_of_iDSBs, c_number_of_cDSBs, c_avg_number_of_DSBs_in_cDSBs)
	return c_output,  c_total_nDSBs._obj.value, c_number_of_iDSBs._obj.value, c_number_of_cDSBs._obj.value, c_avg_number_of_DSBs_in_cDSBs._obj.value, c_total_pDSBs._obj.value
