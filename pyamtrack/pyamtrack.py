...
def AT_run_CPPSC_method(number_of_field_components, E_MeV_u, particle_no, fluence_cm2_or_dose_Gy, material_no,
                        stopping_power_source_no, rdd_model, rdd_parameters, er_model, gamma_model, gamma_parameters,
                        N2, fluence_factor, write_output, shrink_tails, shrink_tails_under, adjust_N2,
                        lethal_events_mode, relative_efficiency, d_check, S_HCP, S_gamma, mean_number_of_tracks_contrib,
                        start_number_of_tracks_contrib, n_convolutions, lower_Jensen_bound, upper_Jensen_bound):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2_or_dose_Gy,
                          c_material_no, c_stopping_power_source_no, c_rdd_model, c_rdd_parameters, c_er_model,
                          c_gamma_model, c_gamma_parameters, c_N2, c_fluence_factor, c_write_output, c_shrink_tails,
                          c_shrink_tails_under, c_adjust_N2, c_lethal_events_mode, c_relative_efficiency, c_d_check,
                          c_S_HCP, c_S_gamma, c_mean_number_of_tracks_contrib, c_start_number_of_tracks_contrib,
                          c_n_convolutions, c_lower_Jensen_bound, c_upper_Jensen_bound)
...
def AT_run_CPPSS_method(number_of_field_components, E_MeV_u, particle_no, fluence_cm2_or_dose_Gy, material_no,
                        stopping_power_source_no, RDD_model, RDD_parameters, ER_model, gamma_model, gamma_parameters,
                        n_runs, N2, fluence_factor, write_output, importance_sampling, results):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2_or_dose_Gy,
                          c_material_no, c_stopping_power_source_no, c_RDD_model, c_RDD_parameters, c_ER_model,
                          c_gamma_model, c_gamma_parameters, c_n_runs, c_N2, c_fluence_factor, c_write_output,
                          c_importance_sampling, c_results)
    return c_output


def AT_GSM_sample_particle_positions(number_of_field_components, fluence_cm2, sample_grid_size_m,
                                     random_number_generator_seed, number_of_particles_in_field_component, x_position,
                                     y_position):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_fluence_cm2, c_sample_grid_size_m,
                          c_random_number_generator_seed, c_number_of_particles_in_field_component, c_x_position,
                          c_y_position)
...
def AT_run_GSM_method(number_of_field_components, E_MeV_u, particle_no, fluence_cm2_or_dose_Gy, material_no,
                      stopping_power_source_no, rdd_model, rdd_parameters, er_model, gamma_model, gamma_parameters,
                      N_runs, write_output, nX, voxel_size_m, lethal_events_mode, relative_efficiency, d_check, S_HCP,
                      S_gamma, n_particles, sd_relative_efficiency, sd_d_check, sd_S_HCP, sd_S_gamma, sd_n_particles):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2_or_dose_Gy,
                          c_material_no, c_stopping_power_source_no, c_rdd_model, c_rdd_parameters, c_er_model,
                          c_gamma_model, c_gamma_parameters, c_N_runs, c_write_output, c_nX, c_voxel_size_m,
                          c_lethal_events_mode, c_relative_efficiency, c_d_check, c_S_HCP, c_S_gamma, c_n_particles,
                          c_sd_relative_efficiency, c_sd_d_check, c_sd_S_HCP, c_sd_S_gamma, c_sd_n_particles)
...
def AT_GSM_local_dose_distrib(number_of_field_components, E_MeV_u, fluence_cm2, particle_no, material_no, rdd_model,
                              rdd_parameter, er_model, stopping_power_source_no, nX, pixel_size_m, number_of_bins,
                              dose_bin_centers_Gy, random_number_generator_seed, zero_dose_fraction, dose_frequency_Gy):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_fluence_cm2, c_particle_no, c_material_no,
                          c_rdd_model, c_rdd_parameter, c_er_model, c_stopping_power_source_no, c_nX, c_pixel_size_m,
                          c_number_of_bins, c_dose_bin_centers_Gy, c_random_number_generator_seed, c_zero_dose_fraction,
                          c_dose_frequency_Gy)
    return c_output, c_random_number_generator_seed._obj.value, c_zero_dose_fraction._obj.value, c_dose_frequency_Gy._obj


def AT_GSM_multiple_local_dose_distrib(number_of_field_components, E_MeV_u, fluence_cm2, particle_no, material_no,
                                       rdd_model, rdd_parameter, er_model, stopping_power_source_no, nX, pixel_size_m,
                                       N_runs, N_repetitions, number_of_bins, dose_bin_centers_Gy, dose_bin_width_Gy,
                                       mean_d_check_Gy, sd_d_check_Gy, mean_zero_dose_fraction, sd_zero_dose_fraction,
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_fluence_cm2, c_particle_no, c_material_no,
                          c_rdd_model, c_rdd_parameter, c_er_model, c_stopping_power_source_no, c_nX, c_pixel_size_m,
                          c_N_runs, c_N_repetitions, c_number_of_bins, c_dose_bin_centers_Gy, c_dose_bin_width_Gy,
                          c_mean_d_check_Gy, c_sd_d_check_Gy, c_mean_zero_dose_fraction, c_sd_zero_dose_fraction,
                          c_mean_dose_frequency_Gy, c_sd_dose_frequency_Gy)
...
def AT_run_IGK_method(number_of_field_components, E_MeV_u, particle_no, fluence_cm2_or_dose_Gy, material_no,
                      stopping_power_source_no, rdd_model, rdd_parameters, er_model, gamma_model, gamma_parameters,
                      saturation_cross_section_factor, write_output, relative_efficiency, S_HCP, S_gamma, sI_cm2,
                      gamma_dose_Gy, P_I, P_g):
    '''
    ...
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2_or_dose_Gy,
                          c_material_no, c_stopping_power_source_no, c_rdd_model, c_rdd_parameters, c_er_model,
                          c_gamma_model, c_gamma_parameters, c_saturation_cross_section_factor, c_write_output,
                          c_relative_efficiency, c_S_HCP, c_S_gamma, c_sI_cm2, c_gamma_dose_Gy, c_P_I, c_P_g)
...
def AT_get_material_data(material_no, density_g_cm3, I_eV, alpha_g_cm2_MeV, p_MeV, m_g_cm2, average_A, average_Z):
    ...
    c_output = c_function(c_material_no, c_density_g_cm3, c_I_eV, c_alpha_g_cm2_MeV, c_p_MeV, c_m_g_cm2, c_average_A,
                          c_average_Z)
...
def AT_get_materials_data(number_of_materials, material_no, density_g_cm3, I_eV, alpha_g_cm2_MeV, p_MeV, m_g_cm2,
                          average_A, average_Z):
    '''
    ...
    c_output = c_function(c_number_of_materials, c_material_no, c_density_g_cm3, c_I_eV, c_alpha_g_cm2_MeV, c_p_MeV,
                          c_m_g_cm2, c_average_A, c_average_Z)
...
def AT_Stopping_Power_Mass_MeV_cm2_g_int(E_MeV_u, params):
    '''
    ...
    c_function = libamtrack.AT_Stopping_Power_Mass_MeV_cm2_g_int
    c_function.restype = ctypes.c_double
...
def AT_CSDA_range_g_cm2_multi(n, E_initial_MeV_u, E_final_MeV_u, particle_no, material_no, CSDA_range_g_cm2):
    '''
    ...
    c_function = libamtrack.AT_CSDA_range_g_cm2_multi
    c_output = c_function(c_n, c_E_initial_MeV_u, c_E_final_MeV_u, c_particle_no, c_material_no, c_CSDA_range_g_cm2)
    return c_output, c_CSDA_range_g_cm2._obj


def AT_CSDA_range_g_cm2_single(E_initial_MeV_u, E_final_MeV_u, particle_no, material_no):
    '''
     * Computes the CSDA range using the PSTAR data
...
def AT_CSDA_energy_after_slab_E_MeV_u_multi(n, E_initial_MeV_u, particle_no, material_no, slab_thickness_m,
                                            E_final_MeV_u):
    '''
...
def AT_WEPL_multi(n, E_MeV_u, particle_no, material_no, slab_thickness_m, WEPL):
    '''
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_WEPL_multi
...
def AT_ER_Scholz_new_range_g_cm2(E_MeV_u):
    '''
    ...
    '''
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_ER_Scholz_new_range_g_cm2
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_ER_AM_RadDiff_range_g_cm2(E_MeV_u):
    '''
     * 6.2e-5 * pow(E_MeV_u, 1.7)
     * @param[in] E_MeV_u
     * @return
    '''
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_ER_AM_RadDiff_range_g_cm2
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output
...
def AT_mean_energy_loss_keV(E_MeV_u, particle_no, material_no, slab_thickness_um):
    '''
    ...
    c_material_no = ctypes.c_long(material_no)
    c_particle_no = ctypes.c_long(particle_no)
    c_slab_thickness_um = ctypes.c_double(slab_thickness_um)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_mean_energy_loss_keV
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um)
    return c_output


def AT_xi_keV(E_MeV_u, particle_no, material_no, slab_thickness_um):
    '''
    ...
    c_slab_thickness_um = ctypes.c_double(slab_thickness_um)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_xi_keV
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um)
    return c_output


def AT_kappa_multi(n, E_MeV_u, particle_no, material_no, slab_thickness_um, kappa):
    '''
    ...
    c_material_no = ctypes.c_long(material_no)
    tmp_array = (ctypes.c_double * n)()
    c_kappa = ctypes.byref(tmp_array)

    tmp_array = ctypes.c_double * len(slab_thickness_um)
    c_slab_thickness_um = ctypes.byref(tmp_array(*slab_thickness_um))
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_kappa_multi
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_kappa)
    return c_output, c_kappa._obj


def AT_kappa_single(E_MeV_u, particle_no, material_no, slab_thickness_um):
    '''
     * TODO
     *
     * @param E_MeV_u
    ...
    c_function = libamtrack.AT_kappa_single
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um)
    return c_output


def AT_Landau_PDF(n, lambda_landau, density):
    '''
    ...
    '''
    tmp_array = ctypes.c_double * len(lambda_landau)
    c_lambda_landau = ctypes.byref(tmp_array(*lambda_landau))

    tmp_array = (ctypes.c_double * n)()
    c_density = ctypes.byref(tmp_array)

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Landau_PDF
    c_output = c_function(c_n, c_lambda_landau, c_density)
    return c_output, c_density._obj


def AT_Landau_IDF(n, rnd, lambda_landau):
    '''
    ...
    '''
    tmp_array = (ctypes.c_double * n)()
    c_lambda_landau = ctypes.byref(tmp_array)

    tmp_array = ctypes.c_double * len(rnd)
    c_rnd = ctypes.byref(tmp_array(*rnd))

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Landau_IDF
    c_output = c_function(c_n, c_rnd, c_lambda_landau)
    return c_output, c_lambda_landau._obj


def AT_lambda_landau_from_energy_loss_multi(n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um,
                                            lambda_landau):
    '''
    ...
    tmp_array = ctypes.c_double * len(energy_loss_keV)
    c_energy_loss_keV = ctypes.byref(tmp_array(*energy_loss_keV))

    c_particle_no = ctypes.c_long(particle_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_lambda_landau_from_energy_loss_multi
    c_output = c_function(c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um,
                          c_lambda_landau)
    return c_output, c_lambda_landau._obj


# problem with function AT_lambda_landau_from_energy_loss_single (zero parameters)
# comment [' *\n', ' * @return\n']

def AT_lambda_mean_multi(n, E_MeV_u, particle_no, material_no, slab_thickness_um, lambda_mean):
    '''
    ...
    c_material_no = ctypes.c_long(material_no)
    tmp_array = (ctypes.c_double * n)()
    c_lambda_mean = ctypes.byref(tmp_array)
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_lambda_mean_multi
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_lambda_mean)
    return c_output, c_lambda_mean._obj
...
def AT_lambda_max_multi(n, E_MeV_u, particle_no, material_no, slab_thickness_um, lambda_max):
    '''
     * Computes the mean lambda, introduced to enable
     * average value for Landau distribution. See Geant3 W5013, p.254
     *
    ...
    c_material_no = ctypes.c_long(material_no)
    tmp_array = (ctypes.c_double * n)()
    c_lambda_max = ctypes.byref(tmp_array)
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_lambda_max_multi
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_lambda_max)
    return c_output, c_lambda_max._obj
...
def AT_energy_loss_from_lambda_landau_multi(n, lambda_landau, E_MeV_u, particle_no, material_no, slab_thickness_um,
                                            energy_loss_keV):
    '''
    ...
    tmp_array = (ctypes.c_double * n)()
    c_energy_loss_keV = ctypes.byref(tmp_array)

    tmp_array = ctypes.c_long * len(particle_no)
    c_particle_no = ctypes.byref(tmp_array(*particle_no))

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_energy_loss_from_lambda_landau_multi
    c_output = c_function(c_n, c_lambda_landau, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um,
                          c_energy_loss_keV)
    return c_output, c_energy_loss_keV._obj
...
def AT_Landau_energy_loss_distribution(n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um, fDdD):
    '''
    ...
    c_particle_no = ctypes.c_long(particle_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Landau_energy_loss_distribution
    c_output = c_function(c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_fDdD)
    return c_output, c_fDdD._obj


def AT_Vavilov_PDF(n, lambda_vavilov, kappa, beta, density):
    '''
     ...
     * @param[out] density             resulting density (array of size n)
    '''
    c_lambda_vavilov = ctypes.c_void_p(lambda_vavilov)
    ...
    c_kappa = (kappa)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Vavilov_PDF
    c_output = c_function(c_n, c_lambda_vavilov, c_kappa, c_beta, c_density)
    return c_output, c_density._obj


def AT_Vavilov_IDF(n, rnd, kappa, beta, lambda_vavilov):
    '''
     * Computes the Vavilov probability density function using CERNLIB (G116)
     *
     * @param[in]  n                   array size
    ...
    '''
    tmp_array = (ctypes.c_double * n)()
    c_lambda_vavilov = ctypes.byref(tmp_array)

    c_beta = ctypes.c_void_p(beta)

    c_rnd = ctypes.c_void_p(rnd)

    c_kappa = ctypes.c_void_p(kappa)

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Vavilov_IDF
    c_output = c_function(c_n, c_rnd, c_kappa, c_beta, c_lambda_vavilov)
    return c_output, c_lambda_vavilov._obj


def AT_lambda_vavilov_from_energy_loss_multi(n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um,
                                             lambda_vavilov):
    '''
     * Computes the lambda parameter for the
    ...
    c_particle_no = ctypes.c_long(particle_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_lambda_vavilov_from_energy_loss_multi
    c_output = c_function(c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um,
                          c_lambda_vavilov)
    return c_output, c_lambda_vavilov._obj


# problem with function AT_lambda_vavilov_from_energy_loss_single (zero parameters)
# comment [' *\n', ' * @return\n']
# problem with function AT_lambda_vavilov_from_energy_loss_single (zero parameters)
# comment [' *\n', ' * @return\n']
# problem with function AT_lambda_vavilov_from_energy_loss_single (zero parameters)
...
def AT_energy_loss_from_lambda_vavilov_multi(n, lambda_vavilov, E_MeV_u, particle_no, material_no, slab_thickness_um,
                                             energy_loss_keV):
    '''
    ...
    '''
    c_material_no = ctypes.c_long(material_no)
    tmp_array = ctypes.c_double * len(lambda_vavilov)
    c_lambda_vavilov = ctypes.byref(tmp_array(*lambda_vavilov))
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_energy_loss_from_lambda_vavilov_multi
    c_output = c_function(c_n, c_lambda_vavilov, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um,
                          c_energy_loss_keV)
    return c_output, c_energy_loss_keV._obj


def AT_Vavilov_energy_loss_distribution(n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um, fDdD):
    '''
     * Computes the energy loss
     * Vavilov distribution acc. to CERN W5013
     *
    ...
    c_particle_no = ctypes.c_long(particle_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Vavilov_energy_loss_distribution
    c_output = c_function(c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_fDdD)
    return c_output, c_fDdD._obj


def AT_Gauss_PDF(n, lambda_gauss, density):
    '''
    ...
    tmp_array = ctypes.c_double * len(lambda_gauss)
    c_lambda_gauss = ctypes.byref(tmp_array(*lambda_gauss))

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Gauss_PDF
    c_output = c_function(c_n, c_lambda_gauss, c_density)
    return c_output, c_density._obj


def AT_Gauss_IDF(n, rnd, lambda_gauss):
    '''
    ...
    '''
    tmp_array = (ctypes.c_double * n)()
    c_lambda_gauss = ctypes.byref(tmp_array)

    tmp_array = ctypes.c_double * len(rnd)
    c_rnd = ctypes.byref(tmp_array(*rnd))

    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Gauss_IDF
    c_output = c_function(c_n, c_rnd, c_lambda_gauss)
    return c_output, c_lambda_gauss._obj


def AT_energy_loss_from_lambda_gauss_multi(n, lambda_gauss, E_MeV_u, particle_no, material_no, slab_thickness_um,
                                           energy_loss_keV):
    '''
     * Computes the energy loss from the lambda parameter of the
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_energy_loss_from_lambda_gauss_multi
    c_output = c_function(c_n, c_lambda_gauss, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um,
                          c_energy_loss_keV)
    return c_output, c_energy_loss_keV._obj
...
def AT_energy_loss_distribution(n, energy_loss_keV, E_MeV_u, particle_no, material_no, slab_thickness_um, fDdD):
    '''
    ...
    c_particle_no = ctypes.c_long(particle_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_energy_loss_distribution
    c_output = c_function(c_n, c_energy_loss_keV, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um, c_fDdD)
    return c_output, c_fDdD._obj


def AT_energy_loss_mode(E_MeV_u, particle_no, material_no, slab_thickness_um):
    '''
    ...
    c_slab_thickness_um = ctypes.c_double(slab_thickness_um)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_energy_loss_mode
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um)
    return c_output


def AT_energy_loss_FWHM(E_MeV_u, particle_no, material_no, slab_thickness_um):
    '''
    ...
    c_slab_thickness_um = ctypes.c_double(slab_thickness_um)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_energy_loss_FWHM
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_um)
    return c_output
...
def AT_get_gamma_response_for_average_dose(number_of_bins, dose_Gy_bin_position, dose_Gy_bin_width, dose_bin_frequency,
                                           gamma_model, gamma_parameter, lethal_events_mode):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_bins, c_dose_Gy_bin_position, c_dose_Gy_bin_width, c_dose_bin_frequency,
                          c_gamma_model, c_gamma_parameter, c_lethal_events_mode)
    return c_output


def AT_get_response_distribution_from_dose_distribution(number_of_bins, dose_Gy_bin_position, dose_bin_frequency,
                                                        gamma_model, gamma_parameter, lethal_events_mode,
    ...
    c_output = c_function(c_number_of_bins, c_dose_Gy_bin_position, c_dose_bin_frequency, c_gamma_model,
                          c_gamma_parameter, c_lethal_events_mode, c_response_bin_frequency)
    return c_output, c_response_bin_frequency._obj


def AT_get_ion_response_from_response_distribution(number_of_bins, dose_Gy_bin_width, dose_bin_frequency,
...
def AT_get_ion_response_from_dose_distribution(number_of_bins, dose_Gy_bin_position, dose_bin_frequency, gamma_model,
                                               gamma_parameter, lethal_events_mode):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_bins, c_dose_Gy_bin_position, c_dose_bin_frequency, c_gamma_model,
                          c_gamma_parameter, c_lethal_events_mode)
    return c_output


def AT_get_ion_efficiency_from_dose_distribution(number_of_bins, dose_Gy_bin_position, dose_bin_frequency, gamma_model,
                                                 gamma_parameter, lethal_events_mode):
    '''
...
def AT_get_ion_efficiency_from_response_distribution(number_of_bins, dose_Gy_bin_position, dose_bin_frequency,
                                                     ion_response_bin_frequency, gamma_model, gamma_parameter,
                                                     lethal_events_mode):
    '''
    ...
    c_output = c_function(c_number_of_bins, c_dose_Gy_bin_position, c_dose_bin_frequency, c_ion_response_bin_frequency,
                          c_gamma_model, c_gamma_parameter, c_lethal_events_mode)
    return c_output


def AT_get_gamma_response(number_of_bins, d_Gy, dd_Gy, f, f0, gamma_model, gamma_parameter, lethal_events_mode, S,
                          S_HCP, S_gamma, efficiency):
    '''
    ...
    c_output = c_function(c_number_of_bins, c_d_Gy, c_dd_Gy, c_f, c_f0, c_gamma_model, c_gamma_parameter,
                          c_lethal_events_mode, c_S, c_S_HCP, c_S_gamma, c_efficiency)
...
def AT_histo_add_multi(number_of_bins, lowest_left_limit, step, histo_type, n_values, value, weight, frequency):
    ...
    c_output = c_function(c_number_of_bins, c_lowest_left_limit, c_step, c_histo_type, c_n_values, c_value, c_weight,
                          c_frequency)
    return c_output
...
def AT_KatzModel_KatzExtTarget_inactivation_probability(r_m, a0_m, KatzPoint_r_min_m, max_electron_range_m, er_model,
                                                        alpha, Katz_plateau_Gy, Katz_point_coeff_Gy,
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_er_model, c_alpha,
                          c_Katz_plateau_Gy, c_Katz_point_coeff_Gy, c_D0_characteristic_dose_Gy, c_c_hittedness,
                          c_m_number_of_targets)
    return c_output


def AT_KatzModel_CucinottaExtTarget_inactivation_probability(r_m, a0_m, KatzPoint_r_min_m, max_electron_range_m, beta,
                                                             C_norm, Cucinotta_plateau_Gy, KatzPoint_point_coeff_Gy,
                                                             D0_characteristic_dose_Gy, c_hittedness,
                                                             m_number_of_targets):
    '''
     * TODO
     * @param[in] r_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_beta, c_C_norm,
                          c_Cucinotta_plateau_Gy, c_KatzPoint_point_coeff_Gy, c_D0_characteristic_dose_Gy,
                          c_c_hittedness, c_m_number_of_targets)
    return c_output


def AT_KatzModel_inactivation_probability(n, r_m, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameters,
                                          er_model, gamma_parameters, stop_power_source, inactivation_probability):
    '''
     * TODO
     * @param[in] n                             todo
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_r_m, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameters,
                          c_er_model, c_gamma_parameters, c_stop_power_source, c_inactivation_probability)
...
def AT_KatzModel_KatzExtTarget_inactivation_cross_section_m2(a0_m, KatzPoint_r_min_m, max_electron_range_m, er_model,
                                                             alpha, Katz_plateau_Gy, Katz_point_coeff_Gy,
                                                             D0_characteristic_dose_Gy, c_hittedness,
                                                             m_number_of_targets):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_er_model, c_alpha, c_Katz_plateau_Gy,
                          c_Katz_point_coeff_Gy, c_D0_characteristic_dose_Gy, c_c_hittedness, c_m_number_of_targets)
    return c_output
...
def AT_KatzModel_CucinottaExtTarget_inactivation_cross_section_m2(a0_m, KatzPoint_r_min_m, max_electron_range_m, beta,
                                                                  C_norm, Cucinotta_plateau_Gy,
                                                                  KatzPoint_point_coeff_Gy, D0_characteristic_dose_Gy,
                                                                  c_hittedness, m_number_of_targets):
    '''
     * TODO
     * @param[in] a0_m
     * @param[in] KatzPoint_r_min_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_beta, c_C_norm, c_Cucinotta_plateau_Gy,
                          c_KatzPoint_point_coeff_Gy, c_D0_characteristic_dose_Gy, c_c_hittedness,
                          c_m_number_of_targets)
    return c_output


def AT_KatzModel_inactivation_cross_section_m2(n, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameters,
                                               er_model, gamma_parameters, stop_power_source,
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameters, c_er_model,
                          c_gamma_parameters, c_stop_power_source, c_inactivation_cross_section_m2)
...
def AT_KatzModel_KatzExtTarget_Zhang_TrackWidth(z2kappabeta2, m):
    '''
     * TODO
     * @param[in] z2kappabeta2  TODO
     * @param[in] m             TODO
     * @return track width
    '''
    c_z2kappabeta2 = (z2kappabeta2)
    c_m = (m)
    c_function = libamtrack.AT_KatzModel_KatzExtTarget_Zhang_TrackWidth
    c_function.restype = ctypes.c_double
    c_output = c_function(c_z2kappabeta2, c_m)
    return c_output


def AT_KatzModel_single_field_survival_from_inactivation_cross_section(fluence_cm2, E_MeV_u, particle_no, material_no,
                                                                       inactivation_cross_section_m2,
                                                                       D0_characteristic_dose_Gy, m_number_of_targets,
                                                                       sigma0_m2, stopping_power_source_no):
    '''
     * TODO
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_fluence_cm2, c_E_MeV_u, c_particle_no, c_material_no, c_inactivation_cross_section_m2,
                          c_D0_characteristic_dose_Gy, c_m_number_of_targets, c_sigma0_m2, c_stopping_power_source_no)
    return c_output


def AT_KatzModel_inactivation_cross_section_approximation_m2(E_MeV_u, particle_no, material_no, rdd_model, er_model,
                                                             m_number_of_targets, sigma0_m2, kappa):
    '''
     * TODO
     * @param[in] E_MeV_u                   TODO
     * @param[in] particle_no               TODO
    ...
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_m_number_of_targets = ctypes.c_double(m_number_of_targets)
    c_function = libamtrack.AT_KatzModel_inactivation_cross_section_approximation_m2
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_er_model, c_m_number_of_targets,
                          c_sigma0_m2, c_kappa)
    return c_output


def AT_KatzModel_single_field_survival(fluence_cm2, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameters,
                                       er_model, D0_characteristic_dose_Gy, m_number_of_targets, sigma0_m2,
                                       use_approximation, kappa, stopping_power_source_no, survival):
    '''
     * TODO
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_fluence_cm2, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameters,
                          c_er_model, c_D0_characteristic_dose_Gy, c_m_number_of_targets, c_sigma0_m2,
                          c_use_approximation, c_kappa, c_stopping_power_source_no, c_survival)
    return c_output, c_survival._obj.value


def AT_KatzModel_mixed_field_survival(number_of_items, fluence_cm2, E_MeV_u, particle_no, material_no, rdd_model,
                                      rdd_parameters, er_model, D0_characteristic_dose_Gy, m_number_of_targets,
                                      sigma0_m2, use_approximation, kappa, stopping_power_source_no, survival):
    '''
     * TODO
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_number_of_items, c_fluence_cm2, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model,
                          c_rdd_parameters, c_er_model, c_D0_characteristic_dose_Gy, c_m_number_of_targets, c_sigma0_m2,
                          c_use_approximation, c_kappa, c_stopping_power_source_no, c_survival)
    return c_output, c_survival._obj.value


def AT_KatzModel_single_field_survival_optimized_for_fluence_vector(number_of_items, fluence_cm2, E_MeV_u, particle_no,
                                                                    material_no, rdd_model, rdd_parameters, er_model,
                                                                    D0_characteristic_dose_Gy, m_number_of_targets,
                                                                    sigma0_m2, use_approximation, kappa,
                                                                    stopping_power_source_no, survival):
    '''
     * TODO
...
def AT_characteristic_single_scattering_angle(n, E_MeV_u, particle_charge_e, target_thickness_cm, element_acronym,
                                              chi_c):
    '''
...
def AT_characteristic_multiple_scattering_angle_single(E_MeV_u, particle_charge_e, target_thickness_cm,
                                                       element_acronym):
    '''
...
def AT_characteristic_multiple_scattering_angle(n, E_MeV_u, particle_charge_e, target_thickness_cm, element_acronym,
                                                Theta_M):
    '''
...
def AT_scattering_angle_distribution(n, E_MeV_u, particle_charge_e, target_thickness_cm, element_acronym, Theta,
                                     distribution):
    '''
     *  Returns scattering angle distribution f(Theta)
     *  The distribution is not normalized because the energy loss in the target is not considered.
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_particle_charge_e, c_target_thickness_cm, c_element_acronym, c_Theta,
                          c_distribution)
...
def AT_gamma_(x, ga):
    ...
    c_function = libamtrack.AT_gamma_
...
def AT_energy_straggling_after_slab_E_MeV_u(n, E_MeV_u, particle_no, material_no, slab_thickness_m,
                                            initial_sigma_E_MeV_u, sigma_E_MeV_u):
    '''
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_slab_thickness_m, c_initial_sigma_E_MeV_u,
                          c_sigma_E_MeV_u)
...
def AT_mass_correction_terms_new(E_MeV_u, A):
    '''
    ...
    c_A = (A)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_mass_correction_terms_new
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_A)
    return c_output


def AT_max_relativistic_E_transfer_MeV_new_single(E_MeV_u, A):
    '''
    ...
    c_A = (A)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_max_relativistic_E_transfer_MeV_new_single
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_A)
    return c_output


def AT_max_classic_E_transfer_MeV_new_single(E_MeV_u, A):
    '''
    ...
    * @return max_classic_E_transfer_MeV
    ...
    c_A = (A)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_max_classic_E_transfer_MeV_new_single
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_A)
    return c_output


def AT_max_E_transfer_MeV_new_single(E_MeV_u, A):
    '''
    ...
    * @return     max_E_transfer_MeV
    ...
    c_A = (A)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_max_E_transfer_MeV_new_single
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_A)
    return c_output


def AT_max_E_transfer_MeV_new(n, E_MeV_u, A, max_E_transfer_MeV):
    '''
    ...
    * @return     status code
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_max_E_transfer_MeV_new
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_A, c_max_E_transfer_MeV)
...
def AT_dose_Gy_from_fluence_cm2(n, E_MeV_u, particle_no, fluence_cm2, material_no, stopping_power_source_no, dose_Gy):
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_fluence_cm2, c_material_no, c_stopping_power_source_no,
                          c_dose_Gy)
...
def AT_fluence_cm2_from_dose_Gy(n, E_MeV_u, particle_no, D_Gy, material_no, stopping_power_source_no, fluence_cm2):
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_D_Gy, c_material_no, c_stopping_power_source_no,
                          c_fluence_cm2)
...
def AT_single_impact_dose_Gy(n, E_MeV_u, particle_no, material_no, er_model, stopping_power_source_no,
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_er_model, c_stopping_power_source_no,
                          c_single_impact_dose_Gy)
...
def AT_total_D_Gy(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no, stopping_power_source_no):
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2, c_material_no,
                          c_stopping_power_source_no)
    return c_output
...
def AT_total_fluence_cm2(number_of_field_components, E_MeV_u, particle_no, D_Gy, material_no, stopping_power_source_no):
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_D_Gy, c_material_no,
                          c_stopping_power_source_no)
    return c_output
...
def AT_dose_weighted_E_MeV_u(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no,
...
def AT_fluence_weighted_LET_MeV_cm2_g(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no,
                                      stopping_power_source_no):
    '''
...
def AT_dose_weighted_LET_MeV_cm2_g(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no,
                                   stopping_power_source_no):
    '''
...
def AT_stopping_power_ratio(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no,
                            reference_material_no, stopping_power_source_no):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2, c_material_no,
                          c_reference_material_no, c_stopping_power_source_no)
    return c_output


def AT_mean_number_of_tracks_contrib(number_of_field_components, E_MeV_u, particle_no, fluence_cm2, material_no,
                                     er_model, stopping_power_source_no):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_number_of_field_components, c_E_MeV_u, c_particle_no, c_fluence_cm2, c_material_no,
                          c_er_model, c_stopping_power_source_no)
    return c_output
...
def AT_D_RDD_Gy(n, r_m, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter, er_model, stopping_power_source_no,
                D_RDD_Gy):
    '''
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_r_m, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter, c_er_model,
                          c_stopping_power_source_no, c_D_RDD_Gy)
    return c_output, c_D_RDD_Gy._obj


def AT_r_RDD_m(n, D_RDD_Gy, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter, er_model,
               stopping_power_source_no, r_RDD_m):
    '''
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_D_RDD_Gy, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter,
                          c_er_model, c_stopping_power_source_no, c_r_RDD_m)
...
def AT_RDD_precalculated_constant_Gy(max_electron_range_m, LET_MeV_cm2_g, E_MeV_u, particle_no, material_no, rdd_model,
                                     rdd_parameter, er_model):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_max_electron_range_m, c_LET_MeV_cm2_g, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model,
                          c_rdd_parameter, c_er_model)
    return c_output
...
def AT_RDD_d_min_Gy(E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter, er_model, precalculated_constant_Gy):
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter, c_er_model,
                          c_precalculated_constant_Gy)
    return c_output
...
def AT_RDD_f1_parameters_single_field(E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter, er_model,
                                      stopping_power_source_no, f1_parameters):
    '''
    ...
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter, c_er_model,
                          c_stopping_power_source_no, c_f1_parameters)
    return c_output, c_f1_parameters._obj


def AT_RDD_f1_parameters_mixed_field(n, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter, er_model,
                                     stopping_power_source_no, f1_parameters):
    '''
     * Pre-calculated many useful parameters characterizing RDD.
     * @param[in]  n                     number of particle types in the mixed particle field
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter, c_er_model,
                          c_stopping_power_source_no, c_f1_parameters)
    return c_output, c_f1_parameters._obj
...
def AT_RDD_ExtendedTarget_KatzPoint_Gy_by_integration(r_m, a0_m, er_model, KatzPoint_r_min_m, max_electron_range_m,
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_er_model, c_KatzPoint_r_min_m, c_max_electron_range_m, c_alpha,
                          c_Katz_point_coeff_Gy)
    return c_output


def AT_RDD_ExtendedTarget_KatzPoint_Gy(r_m, a0_m, er_model, KatzPoint_r_min_m, max_electron_range_m, alpha,
                                       Katz_plateau_Gy, Katz_point_coeff_Gy):
    '''
     * TODO
     * @param[in] r_m
     * @param[in] a0_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_er_model, c_KatzPoint_r_min_m, c_max_electron_range_m, c_alpha,
                          c_Katz_plateau_Gy, c_Katz_point_coeff_Gy)
    return c_output
...
def AT_inverse_RDD_ExtendedTarget_KatzPoint_m(D_Gy, r_min_m, max_electron_range_m, a0_m, er_model, alpha,
                                              Katz_plateau_Gy, Katz_point_coeff_Gy):
    '''
     * TODO
     * @param[in] D_Gy
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_D_Gy, c_r_min_m, c_max_electron_range_m, c_a0_m, c_er_model, c_alpha, c_Katz_plateau_Gy,
                          c_Katz_point_coeff_Gy)
    return c_output
...
def AT_RDD_ExtendedTarget_CucinottaPoint_Gy_by_integration(r_m, a0_m, KatzPoint_r_min_m, max_electron_range_m, beta,
                                                           Katz_point_coeff_Gy, C_norm):
    '''
     * TODO
     * @param[in] r_m
     * @param[in] a0_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_beta, c_Katz_point_coeff_Gy,
                          c_C_norm)
    return c_output


def AT_RDD_ExtendedTarget_CucinottaPoint_Gy(r_m, a0_m, KatzPoint_r_min_m, max_electron_range_m, beta,
                                            Katz_point_coeff_Gy, C_norm, Cucinotta_plateau_Gy):
    '''
     * TODO
     * @param[in] r_m
     * @param[in] a0_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_beta, c_Katz_point_coeff_Gy,
                          c_C_norm, c_Cucinotta_plateau_Gy)
    return c_output
...
def AT_inverse_RDD_ExtendedTarget_CucinottaPoint_m(D_Gy, a0_m, KatzPoint_r_min_m, max_electron_range_m, beta,
                                                   Katz_point_coeff_Gy, C_norm, Cucinotta_plateau_Gy):
    '''
     * TODO
     * @param[in] D_Gy
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_D_Gy, c_a0_m, c_KatzPoint_r_min_m, c_max_electron_range_m, c_beta, c_Katz_point_coeff_Gy,
                          c_C_norm, c_Cucinotta_plateau_Gy)
    return c_output
...
def AT_RDD_Cucinotta_Cnorm(r_min_m, max_electron_range_m, beta, material_density_kg_m3, LET_J_m, Katz_point_coeff_Gy):
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_min_m, c_max_electron_range_m, c_beta, c_material_density_kg_m3, c_LET_J_m,
                          c_Katz_point_coeff_Gy)
    return c_output
...
def AT_RDD_Katz_LinearER_DSite_Gy(r_m, a0_m, max_electron_range_m, material_density_kg_m3, LET_J_m, dEdx_J_m,
                                  Katz_point_coeff_Gy):
    '''
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_max_electron_range_m, c_material_density_kg_m3, c_LET_J_m, c_dEdx_J_m,
                          c_Katz_point_coeff_Gy)
    return c_output


def AT_RDD_Katz_PowerLawER_DSite_Gy(r_m, a0_m, max_electron_range_m, material_density_kg_m3, alpha, LET_J_m, dEdx_J_m,
                                    Katz_point_coeff_Gy):
    '''
     * Calculates Site RDD, which is LET-normalized
     * for "new" Katz RDD (derived from power-law (on wmax) ER model).
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_a0_m, c_max_electron_range_m, c_material_density_kg_m3, c_alpha, c_LET_J_m,
                          c_dEdx_J_m, c_Katz_point_coeff_Gy)
    return c_output


def AT_RDD_KatzSite_Gy(r_m, r_min_m, max_electron_range_m, a0_m, er_model, alpha, density_kg_m3, LET_J_m, dEdx_J_m,
                       Katz_point_coeff_Gy):
    '''
     * TODO
     * @param[in] r_m
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_r_min_m, c_max_electron_range_m, c_a0_m, c_er_model, c_alpha, c_density_kg_m3,
                          c_LET_J_m, c_dEdx_J_m, c_Katz_point_coeff_Gy)
    return c_output


def AT_inverse_RDD_KatzSite_m(D_Gy, r_min_m, max_electron_range_m, a0_m, er_model, alpha, d_max_Gy,
                              Katz_point_coeff_Gy):
    '''
     * TODO
     * @param[in] D_Gy
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_D_Gy, c_r_min_m, c_max_electron_range_m, c_a0_m, c_er_model, c_alpha, c_d_max_Gy,
                          c_Katz_point_coeff_Gy)
    return c_output
...
def AT_inverse_RDD_Cucinotta_m(D_Gy, r_min_m, max_electron_range_m, er_model, beta, C_norm, Katz_point_coeff_Gy):
    ...
    c_function.restype = ctypes.c_double
    c_output = c_function(c_D_Gy, c_r_min_m, c_max_electron_range_m, c_er_model, c_beta, c_C_norm,
                          c_Katz_point_coeff_Gy)
    return c_output


def AT_RDD_RadicalDiffusion_get_energy_idx(E_MeV_u):
    '''
     * Returns energy index
     *
     * @param[in]   E_MeV_u		energy in MeV/u
     * @return      energy index
    '''
    c_E_MeV_u = (E_MeV_u)
    c_function = libamtrack.AT_RDD_RadicalDiffusion_get_energy_idx
    c_function.restype = ctypes.c_long
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_RDD_RadicalDiffusion_Gy(r_m, E_MeV_u, particle_no, material_no):
    '''
     * Returns radial dose for the radical diffusion model
     *
     * @param[in]   r_m		radius (distance from track) in m
     * @param[in]   E_MeV_u		energy in MeV/u
     * @param[in]	particle_no	particle number
     * @param[in]	material_no material index
     * @return      radial dose in Gy
    '''
    c_material_no = ctypes.c_long(material_no)
    c_particle_no = ctypes.c_long(particle_no)
    c_r_m = ctypes.c_double(r_m)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_RDD_RadicalDiffusion_Gy
    c_function.restype = ctypes.c_double
    c_output = c_function(c_r_m, c_E_MeV_u, c_particle_no, c_material_no)
    return c_output


def AT_inverse_RadicalDiffusion_m(d_Gy, E_MeV_u, particle_no, material_no):
    '''
     * Returns radius for the radical diffusion model
     *
     * @param[in]   d_Gy	radial dose in Gy
     * @param[in]   E_MeV_u		energy in MeV/u
     * @param[in]	particle_no	particle number
     * @param[in]	material_no material index
     * @return      radius in m
    ...
    c_particle_no = ctypes.c_long(particle_no)
    c_d_Gy = ctypes.c_double(d_Gy)
    c_function = libamtrack.AT_inverse_RadicalDiffusion_m
    c_function.restype = ctypes.c_double
    c_output = c_function(c_d_Gy, c_E_MeV_u, c_particle_no, c_material_no)
    return c_output


def AT_r_min_RadicalDiffusion_m(E_MeV_u):
    '''
     * Returns minimal radius for the radical diffusion model
     *
     * @param[in]   E_MeV_u		energy in MeV/u
     * @return      minimal radius in m
    '''
    c_E_MeV_u = (E_MeV_u)
    c_function = libamtrack.AT_r_min_RadicalDiffusion_m
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_r_max_RadicalDiffusion_m(E_MeV_u):
    '''
     * Returns maximum radius for the radical diffusion model
     *
     * @param[in]   E_MeV_u		energy in MeV/u
     * @return      maximum radius in m
    '''
    c_E_MeV_u = (E_MeV_u)
    c_function = libamtrack.AT_r_max_RadicalDiffusion_m
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_d_min_RadicalDiffusion_Gy(E_MeV_u):
    '''
    ...
    '''
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_d_min_RadicalDiffusion_Gy
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_d_max_RadicalDiffusion_Gy(E_MeV_u):
    '''
    ...
    '''
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_d_max_RadicalDiffusion_Gy
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_E_RadicalDiffusion_MeV_u(E_MeV_u):
    '''
     * Returns energy for the radical diffusion model
     *
     * @param[in]   E_MeV_u		energy in MeV/u
     * @return      energy in MeV per nucleon
    '''
    c_E_MeV_u = (E_MeV_u)
    c_function = libamtrack.AT_E_RadicalDiffusion_MeV_u
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u)
    return c_output


def AT_n_bins_RadicalDiffusion(E_MeV_u):
    '''
    ...
    '''
    c_E_MeV_u = (E_MeV_u)
    c_function = libamtrack.AT_n_bins_RadicalDiffusion
    c_function.restype = ctypes.c_long
    c_output = c_function(c_E_MeV_u)
    return c_output
...
def AT_SPC_decompose_header(content_size, content_orig, E_MeV_u, peak_position_g_cm2, particle_no, material_no,
                            normalisation, depth_steps_no):
    '''
     * TODO
     * @param[in]	content_size  	    size of table content_orig
     * @param[in]	content_orig  	    table of bytes containing binary content of SPC file (array of size content_size)
    ...
    c_output = c_function(c_content_size, c_content_orig, c_E_MeV_u, c_peak_position_g_cm2, c_particle_no,
                          c_material_no, c_normalisation, c_depth_steps_no)
...
def AT_SPC_decompose_data(content_size, content_orig, depth_step, depth_g_cm2, E_MeV_u, DE_MeV_u, particle_no,
                          fluence_cm2):
    '''
     * TODO
     * @param[in]	content_size  	    size of table content_orig
    ...
    c_output = c_function(c_content_size, c_content_orig, c_depth_step, c_depth_g_cm2, c_E_MeV_u, c_DE_MeV_u,
                          c_particle_no, c_fluence_cm2)
...
def AT_SPC_read_header_from_filename_fast(filename, E_MeV_u, peak_position_g_cm2, particle_no, material_no,
                                          normalisation, depth_steps_no):
    '''
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_filename, c_E_MeV_u, c_peak_position_g_cm2, c_particle_no, c_material_no, c_normalisation,
                          c_depth_steps_no)
    return c_output, c_E_MeV_u._obj.value, c_peak_position_g_cm2._obj.value, c_particle_no._obj.value, c_material_no._obj.value, c_normalisation._obj.value, c_depth_steps_no._obj.value


def AT_SPC_read_data_from_filename_fast(filename, n, depth_step, depth_g_cm2, E_MeV_u, DE_MeV_u, particle_no,
                                        fluence_cm2):
    '''
     * Reads data from spc file into pre-allocated arrays. It will be converted
     * for direct use in libamtrack, i.e. to an R-style array of six columns
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_filename, c_n, c_depth_step, c_depth_g_cm2, c_E_MeV_u, c_DE_MeV_u, c_particle_no,
                          c_fluence_cm2)
    return c_output, c_depth_step._obj, c_depth_g_cm2._obj, c_E_MeV_u._obj, c_DE_MeV_u._obj, c_particle_no._obj, c_fluence_cm2._obj


def AT_SPC_read_from_filename_fast(filename, n, E_MeV_u_initial, peak_position_g_cm2, particle_no_initial, material_no,
                                   normalisation, depth_steps_no, depth_step, depth_g_cm2, E_MeV_u, DE_MeV_u,
                                   particle_no, fluence_cm2):
    '''
     * Reads data from spc file into pre-allocated arrays. It will be converted
     * for direct use in libamtrack, i.e. to an R-style array of six columns
     * (each presented by a single pointer) and all of same length. That of course
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_filename, c_n, c_E_MeV_u_initial, c_peak_position_g_cm2, c_particle_no_initial,
                          c_material_no, c_normalisation, c_depth_steps_no, c_depth_step, c_depth_g_cm2, c_E_MeV_u,
                          c_DE_MeV_u, c_particle_no, c_fluence_cm2)
...
def AT_SPC_spectrum_at_range(path, range_g_cm2, n, depth_step, depth_g_cm2, E_MeV_u, DE_MeV_u, particle_no,
                             fluence_cm2):
    '''
     * TODO
     *
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_path, c_range_g_cm2, c_n, c_depth_step, c_depth_g_cm2, c_E_MeV_u, c_DE_MeV_u, c_particle_no,
                          c_fluence_cm2)
    return c_output, c_depth_step._obj, c_depth_g_cm2._obj, c_E_MeV_u._obj, c_DE_MeV_u._obj, c_particle_no._obj, c_fluence_cm2._obj


def AT_Mass_Stopping_Power(stopping_power_source, n, E_MeV_u, particle_no, material_no, stopping_power_MeV_cm2_g):
    '''
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Mass_Stopping_Power
    c_function.restype = ctypes.c_int
    c_output = c_function(c_stopping_power_source, c_n, c_E_MeV_u, c_particle_no, c_material_no,
                          c_stopping_power_MeV_cm2_g)
...
def AT_Stopping_Power(stopping_power_source, n, E_MeV_u, particle_no, material_no, stopping_power_keV_um):
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_stopping_power_source, c_n, c_E_MeV_u, c_particle_no, c_material_no,
                          c_stopping_power_keV_um)
    return c_output, c_stopping_power_keV_um._obj


def AT_Mass_Stopping_Power_with_no(stopping_power_source_no, n, E_MeV_u, particle_no, material_no,
    ...
    c_stopping_power_source_no = ctypes.c_long(stopping_power_source_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Mass_Stopping_Power_with_no
    c_function.restype = ctypes.c_int
    c_output = c_function(c_stopping_power_source_no, c_n, c_E_MeV_u, c_particle_no, c_material_no,
                          c_stopping_power_MeV_cm2_g)
    return c_output, c_stopping_power_MeV_cm2_g._obj


def AT_Stopping_Power_with_no(stopping_power_source_no, n, E_MeV_u, particle_no, material_no, stopping_power_keV_um):
    '''
     * Retrieves the electronic stopping power in keV/um for
     * the requested energies and particles for a specified
     * material and data source. The data source is thereby
    ...
    c_stopping_power_source_no = ctypes.c_long(stopping_power_source_no)
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_Stopping_Power_with_no
    c_function.restype = ctypes.c_int
    c_output = c_function(c_stopping_power_source_no, c_n, c_E_MeV_u, c_particle_no, c_material_no,
                          c_stopping_power_keV_um)
    return c_output, c_stopping_power_keV_um._obj
...
def AT_Energy_MeV_u_from_Stopping_Power_single(stopping_power_source_no, Stopping_Power_MeV_cm2_g, particle_no,
                                               material_no):
    '''
     * TODO
     * @param[in] stopping_power_source_no
...
def AT_Bethe_wrapper(n, E_MeV_u, particle_no, material_no, info, mass_stopping_power_MeV_cm2_g):
    '''
    ...
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_info, c_mass_stopping_power_MeV_cm2_g)
    return c_output, c_mass_stopping_power_MeV_cm2_g._obj


def AT_el_energy_loss_leading_term_MeV_cm2_g(E_MeV_u, particle_no, material_no, use_effective_charge):
    '''
    ...
    '''
    c_material_no = ctypes.c_long(material_no)
    c_use_effective_charge = ctypes.c_bool(use_effective_charge)
    c_particle_no = ctypes.c_long(particle_no)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_el_energy_loss_leading_term_MeV_cm2_g
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_use_effective_charge)
    return c_output


def AT_Bethe_Stopping_Number(E_MeV_u, particle_no, material_no, E_restricted_keV):
    '''
    ...
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_Bethe_Stopping_Number
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_E_restricted_keV)
    return c_output


def AT_Bethe_energy_loss_MeV_cm2_g_single(E_MeV_u, particle_no, material_no, E_restricted_keV):
    '''
    ...
    c_E_restricted_keV = ctypes.c_double(E_restricted_keV)
    c_E_MeV_u = ctypes.c_double(E_MeV_u)
    c_function = libamtrack.AT_Bethe_energy_loss_MeV_cm2_g_single
    c_function.restype = ctypes.c_double
    c_output = c_function(c_E_MeV_u, c_particle_no, c_material_no, c_E_restricted_keV)
    return c_output


def AT_FromFile_wrapper(n, E_MeV_u, particle_no, material_no, info, mass_stopping_power_MeV_cm2_g):
    '''
     * Returns the electronic mass stopping power in MeV*cm2/g
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_FromFile_wrapper
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_info, c_mass_stopping_power_MeV_cm2_g)
    return c_output, c_mass_stopping_power_MeV_cm2_g._obj


def AT_ICRU_wrapper(n, E_MeV_u, particle_no, material_no, info, mass_stopping_power_MeV_cm2_g):
    '''
     * Returns the electronic mass stopping power in MeV*cm2/g
...
def AT_PSTAR_wrapper(n, E_MeV_u, particle_no, material_no, info, mass_stopping_power_MeV_cm2_g):
    '''
     * Returns the electronic mass stopping power in MeV*cm2/g
    ...
    c_n = ctypes.c_long(n)
    c_function = libamtrack.AT_PSTAR_wrapper
    c_function.restype = ctypes.c_int
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_info, c_mass_stopping_power_MeV_cm2_g)
    return c_output, c_mass_stopping_power_MeV_cm2_g._obj


def AT_n_bins_for_single_impact_local_dose_distrib(n, E_MeV_u, particle_no, material_no, rdd_model, rdd_parameter,
                                                   er_model, N2, stopping_power_source_no):
    '''
    ...
    c_function.restype = ctypes.c_long
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_material_no, c_rdd_model, c_rdd_parameter, c_er_model, c_N2,
                          c_stopping_power_source_no)
    return c_output


def AT_single_impact_local_dose_distrib(n, E_MeV_u, particle_no, fluence_cm2_or_dose_Gy, material_no, rdd_model,
                                        rdd_parameter, er_model, N2, f1_parameters, n_bins_f1, stopping_power_source_no,
                                        f1_d_Gy, f1_dd_Gy, f1):
    '''
    ...
    c_output = c_function(c_n, c_E_MeV_u, c_particle_no, c_fluence_cm2_or_dose_Gy, c_material_no, c_rdd_model,
                          c_rdd_parameter, c_er_model, c_N2, c_f1_parameters, c_n_bins_f1, c_stopping_power_source_no,
                          c_f1_d_Gy, c_f1_dd_Gy, c_f1)
    return c_output, c_f1_d_Gy._obj, c_f1_dd_Gy._obj, c_f1._obj


def AT_n_bins_for_low_fluence_local_dose_distribution(u, fluence_factor, N2, n_bins_f1, f1_d_Gy, f1_dd_Gy, f1, n_bins_f,
                                                      u_start, n_convolutions):
    '''
    ...
    c_output = c_function(c_u, c_fluence_factor, c_N2, c_n_bins_f1, c_f1_d_Gy, c_f1_dd_Gy, c_f1, c_n_bins_f, c_u_start,
                          c_n_convolutions)
...
def AT_SuccessiveConvolutions(final_mean_number_of_tracks_contrib, n_bins, N2, n_bins_f_used, f_d_Gy, f_dd_Gy, f, f0,
                              fdd, dfdd, d, write_output, shrink_tails, shrink_tails_under, adjust_N2):
    '''
     ...
     * @param[out]     f0                  zero-dose f value (as bins are log this has to be sepa
ted)
    ...
    c_output = c_function(c_final_mean_number_of_tracks_contrib, c_n_bins, c_N2, c_n_bins_f_used, c_f_d_Gy, c_f_dd_Gy,
                          c_f, c_f0, c_fdd, c_dfdd, c_d, c_write_output, c_shrink_tails, c_shrink_tails_under,
                          c_adjust_N2)
    return c_output, c_dfdd._obj, c_d._obj.value, c_f0._obj.value, c_fdd._obj


def AT_Kellerer_normalize(values_first_bin, value_midpoints, value_bin_widths, frequency_n_bins, frequency_zero_bin,
                          frequency_first_bin, frequency):
    '''
    ...
    c_output = c_function(c_values_first_bin, c_value_midpoints, c_value_bin_widths, c_frequency_n_bins,
                          c_frequency_zero_bin, c_frequency_first_bin, c_frequency)
    return c_output, c_frequency._obj
...
def AT_Kellerer_folding(n_bins, bins_per_factor_2, delta_i, values_first_bin, values_bin_widths, frequency_n_bins_last,
                        frequency_first_bin_last, frequency_zero_bin_last, frequency_last, frequency_n_bins,
                        frequency_first_bin, frequency_zero_bin, frequency):
    '''
    ...
    c_output = c_function(c_n_bins, c_bins_per_factor_2, c_delta_i, c_values_first_bin, c_values_bin_widths,
                          c_frequency_n_bins_last, c_frequency_first_bin_last, c_frequency_zero_bin_last,
                          c_frequency_last, c_frequency_n_bins, c_frequency_first_bin, c_frequency_zero_bin,
                          c_frequency)
    return c_output
...
def AT_translate_dose_into_DSB_distribution(n_bins_f, f_d_Gy, f_dd_Gy, f, enhancement_factor, DSB_per_Gy_per_domain,
                                            domains_per_nucleus, write_output, total_pDSBs, total_nDSBs,
                                            number_of_iDSBs, number_of_cDSBs, avg_number_of_DSBs_in_cDSBs):
    '''
    ...
    '''
    c_number_of_iDSBs = ctypes.byref(ctypes.c_double(number_of_iDSBs))

    tmp_array = ctypes.c_double * len(enhancement_factor)
    c_enhancement_factor = ctypes.byref(tmp_array(*enhancement_factor))

    c_DSB_per_Gy_per_domain = ctypes.c_double(DSB_per_Gy_per_domain)
    c_total_pDSBs = ctypes.byref(ctypes.c_double(total_pDSBs))

    c_domains_per_nucleus = ctypes.c_long(domains_per_nucleus)
    tmp_array = ctypes.c_double * len(f)
    c_f = ctypes.byref(tmp_array(*f))

    c_total_nDSBs = ctypes.byref(ctypes.c_double(total_nDSBs))

    c_avg_number_of_DSBs_in_cDSBs = ctypes.byref(ctypes.c_double(avg_number_of_DSBs_in_cDSBs))

    c_number_of_cDSBs = ctypes.byref(ctypes.c_double(number_of_cDSBs))
    ...
    c_write_output = ctypes.c_bool(write_output)
    c_n_bins_f = ctypes.c_long(n_bins_f)
    c_function = libamtrack.AT_translate_dose_into_DSB_distribution
    c_output = c_function(c_n_bins_f, c_f_d_Gy, c_f_dd_Gy, c_f, c_enhancement_factor, c_DSB_per_Gy_per_domain,
                          c_domains_per_nucleus, c_write_output, c_total_pDSBs, c_total_nDSBs, c_number_of_iDSBs,
                          c_number_of_cDSBs, c_avg_number_of_DSBs_in_cDSBs)
    return c_output, \
           c_total_nDSBs._obj.value, \
           c_number_of_iDSBs._obj.value, \
           c_number_of_cDSBs._obj.value, \
           c_avg_number_of_DSBs_in_cDSBs._obj.value, \
           c_total_pDSBs._obj.value
